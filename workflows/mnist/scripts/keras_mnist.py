...
(mnist_images, mnist_labels), _ = \
    tf.keras.datasets.mnist.load_data(path='/workspace/workflows/mnist/mnist.npz')
...
mnist_model.fit(dataset, steps_per_epoch=6000 // hvd.size(), callbacks=callbacks, epochs=epochs, verbose=verbose)
