...
Using CI with Popper workflows enhances the reproducibility guarantees as continuous validation helps to keep a check on various breaking changes like outdated dependencies, broken links, or deleted Docker images.
...
**Acknowledgements**: This work was partially funded by the Center for Research in Open Source Software (CROSS)[^cross], Institute for Research and Innovation in Software for High Energy Physics (IRIS-HEP)[^iris-hep], and NSF Award #1450488.
